...
alter table buy_book
    add constraint buy_book_buy_buy_id
        foreign key (buy_id) references buy (buy_id);

alter table client
    add constraint client_buy_client_id
        foreign key (client_id) references buy (client_id);
        
alter table book
    add constraint book_buy_book_book_id
        foreign key (book_id) references buy_book (book_id);
